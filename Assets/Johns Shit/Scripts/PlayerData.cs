...
public class StatBlock
{
    ...
    static readonly float[] baseTranValues = {1, 0, 0, 1 }; // soul strength, void grip, void gain, void gate
    float[] modTranValues = new float[4];
    #endregion
    ...
    public void ChangeTranValues(float[] array)
    {
        if (array.Length == 4)
        {
            float[] finalReturn = new float[8];
            for (int vv = 0; vv < baseTranValues.Length; vv++)
            {
                ...
                {
                    case 1:
                        modTranValues[vv] += (int)array[vv];
                        break;
                    case 0:
                    case 2:
                    case 3:
                        modTranValues[vv] += array[vv];
                        break;
                }
            }
        }
    ...
    public void NewStatBlock()
    {
        ...
        modTranValues = new float[] { 0, 0, 0, 0 };
        if (StatsDisplayController.main != null) StatsDisplayController.main.AlterStatsDisplay(this);    
    }
